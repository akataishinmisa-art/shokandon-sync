...
(async () => {
    ...
    for (let r = 2; r < 100; r++) {
        ...
        if (auctionData.statusText === '欠品') {
            console.log(`Row ${r} is 欠品 (SOLDOUT). Writing '欠品' into C${r} and F${r}, then skipping price updates.`);
    ...
    await page.screenshot({ path: 'C:\\Users\\akata\\.gemini\\antigravity\\scratch\\soldout_in_c_result.png' });
