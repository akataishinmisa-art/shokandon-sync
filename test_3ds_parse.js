...
(async () => {
    try {
        ...
        const testUrl = 'https://store.shopping.yahoo.co.jp/entameoukoku/3226.html';
        ...
        await page.screenshot({ path: 'C:\\Users\\akata\\.gemini\\antigravity\\scratch\\3ds_ll_parsed_result.png' });
        console.log('Saved 3ds_ll_parsed_result.png');
