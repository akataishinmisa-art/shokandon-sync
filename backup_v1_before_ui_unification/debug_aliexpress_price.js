...
(async () => {
    ...
    console.log('Inspecting AliExpress price DOM structure...');
    ...
    try {
        ...
        const priceDetails = await page.evaluate(() => {
            ...
            allElements.forEach(el => {
                ...
                if (text.includes('円') && text.length < 30) {
        ...
        console.log('Price Nodes found:', JSON.stringify(priceDetails, null, 2));
    } catch (e) {
