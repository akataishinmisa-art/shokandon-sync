...
(async () => {
    ...
    async function getCellUrl(cellName) {
        ...
        // Try Ctrl+K to extract link target URL
        await page.keyboard.down('Control');
    ...
    // Loop through rows starting from 2 until B is empty
    for (let r = 2; r < 100; r++) {
        console.log(`\n================ Processing Row ${r} ================`);
    ...
    await page.screenshot({ path: 'C:\\Users\\akata\\.gemini\\antigravity\\scratch\\all_rows_processed.png' });
