...
(async () => {
    const url = 'https://jp.mercari.com/item/m93721361433';
    ...
    try {
        ...
        const info = await page.evaluate(() => {
            ...
            const buyBtn = document.querySelector('[data-testid="checkout-button"]') || document.querySelector('button[disabled]');
            const isSoldout = document.body.textContent.includes('売り切れ') ||
                              document.body.textContent.includes('SOLD') ||
                              (buyBtn && buyBtn.textContent.includes('売り切れ'));
        ...
        await page.screenshot({ path: 'C:\\Users\\akata\\.gemini\\antigravity\\scratch\\mercari_page.png' });
    } catch (e) {
